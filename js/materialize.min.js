...
jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (! function(e) {
            ...
            if (a) {
                if (s)
                    for (; i > o && (n = r.apply(e[o], a), n !== !1); o++) {} else
                        for (o in e) { if (n = r.apply(e[o], a), n === !1) break }
            } else if (s)
    ...
    return function(e, t, r, a) {
        ...
        function p(e, t) {
            ...
            b.State.calls[e] = !1;
            for (var m = 0, y = b.State.calls.length; y > m; m++) { if (b.State.calls[m] !== !1) { l = !0; break } }
...
! function(a, b, c, d) {
    ...
    kc.prototype = {
        ...
        get: function(a) { if (a instanceof Yb) return a; for (var b = this.recognizers, c = 0; c < b.length; c++) { if (b[c].options.event == a) return b[c] } return null },
...
Materialize.guid = function() {
    function s4() { return Math.floor((1 + Math.random()) * 65536).toString(16).substring(1) }
...
var Vel;
if (jQuery) { Vel = jQuery.Velocity } else if ($) { Vel = $.Velocity } else { Vel = Velocity }(function($) {
    ...
    $.fn.dropdown = function(options) {
        ...
        this.each(function() {
            ...
            function placeDropdown(eventType) {
                ...
                if (curr_options.constrainWidth === true) { activates.css("width", originWidth) } else { activates.css("white-space", "nowrap") }
...
(function($) {
    "use strict";
    var _defaults = { opacity: .5, inDuration: 250, outDuration: 250, ready: undefined, complete: undefined, dismissible: true, startingTop: "4%", endingTop: "10%" };
    var Modal = function() {
        ...
        _createClass(Modal, [{ key: "getInstance", value: function getInstance() { return this } }, {
            ...
            value: function animateIn() {
                ...
                var enterVelocityOptions = { duration: this.options.inDuration, queue: false, ease: "easeOutCubic", complete: function() { if (typeof _this.options.ready === "function") { _this.options.ready.call(_this, _this.$el, _this.openingTrigger) } } };
                if (this.$el[0].classList.contains("bottom-sheet")) { Vel(this.$el[0], { bottom: 0, opacity: 1 }, enterVelocityOptions) } else {
            ...
            value: function animateOut() {
                ...
                if (this.$el[0].classList.contains("bottom-sheet")) { Vel(this.$el[0], { bottom: "-100%", opacity: 0 }, exitVelocityOptions) } else { Vel(this.$el[0], { top: this.options.startingTop, opacity: 0, scaleX: .7 }, exitVelocityOptions) }
            }
        }, {
            key: "open",
            ...
            value: function init($els, options) {
                var arr = [];
                $els.each(function() { arr.push(new Modal($(this), options)) });
                return arr
            }
    ...
    $.fn.modal = function(methodOrOptions) { if (Modal.prototype[methodOrOptions]) { if (methodOrOptions.slice(0, 3) === "get") { return this.first()[0].M_Modal[methodOrOptions]() } else { return this.each(function() { this.M_Modal[methodOrOptions]() }) } } else if (typeof methodOrOptions === "object" || !methodOrOptions) { Modal.init(this, arguments[0]); return this } else { $.error("Method " + methodOrOptions + " does not exist on jQuery.modal") } }
})(jQuery);
(function($) {
    $.fn.materialbox = function() {
        return this.each(function() {
            ...
            origin.on("click", function() {
                ...
                origin.css({ position: "absolute", "z-index": 1e3, "will-change": "left, top, width, height" }).data("width", originalWidth).data("height", originalHeight);
    ...
    var methods = {
        init: function(options) {
            ...
            return this.each(function(i) {
                ...
                var calcRightPos = function(el) { return Math.ceil($tabs_width - el.position().left - el[0].getBoundingClientRect().width - $this.scrollLeft()) };
                    ...
                    $(".tabs-content.carousel").carousel({
                        ...
                        onCycleTo: function(item) {
                            if (!clicked) {
                                ...
                                if (typeof options.onShow === "function") { options.onShow.call($this[0], $content) }
                            }
                        }
                    })
                ...
                $this.off("click.tabs").on("click.tabs", "a", function(e) {
                    ...
                    if (index < 0) { index = 0 }
                    if (options.swipeable) { if ($tabs_content.length) { $tabs_content.carousel("set", index, function() { if (typeof options.onShow === "function") { options.onShow.call($this[0], $content) } }) } } else {
...
(function(window) {
    ...
    function getWavesEffectElement(e) {
        ...
        while (target.parentNode !== null) {
            if (!(target instanceof SVGElement) && target.className.indexOf("waves-effect") !== -1) { element = target; break }
...
(function($) {
    ...
    var Toast = function() {
        ...
        _createClass(Toast, [{
            ...
            value: function remove() {
                ...
                Vel(this.el, { opacity: 0, marginTop: "-40px" }, {
                    ...
                    queue: false,
                    complete: function() {
                        if (typeof _this4.options.completeCallback === "function") { _this4.options.completeCallback() }
        ...
        }, { key: "_xPos", value: function _xPos(e) { if (e.targetTouches && e.targetTouches.length >= 1) { return e.targetTouches[0].clientX } return e.clientX } }, { key: "removeAll", value: function removeAll() { for (var toastIndex in Toast._toasts) { Toast._toasts[toastIndex].remove() } } }, { key: "defaults", get: function() { return _defaults } }]);
        return Toast
    }();
    Toast._toasts = [];
    Toast._container = null;
...
(function($) {
    var methods = {
        init: function(options) {
            var defaults = { menuWidth: 300, edge: "left", closeOnClick: false, draggable: true, onOpen: null, onClose: null };
            options = $.extend(defaults, options);
            $(this).each(function() {
                var $this = $(this);
                ...
                if (options.draggable) {
                    ...
                    $dragTarget.hammer({ prevent_default: false }).on("pan", function(e) {
                        if (e.gesture.pointerType == "touch") {
                            ...
                            if ($overlay.length === 0) {
                                ...
                                if (typeof options.onOpen === "function") { options.onOpen.call(this, menu) }
                                $("body").append($overlay)
                            }
...
(function($) {
    ...
    $.scrollSpy = function(selector, options) {
        var defaults = { throttle: 100, scrollOffset: 200, activeClass: "active", getActiveElement: function(id) { return 'a[href="#' + id + '"]' } };
        options = $.extend(defaults, options);
        var visible = [];
        selector = $(selector);
        ...
        selector.on("scrollSpy:enter", function() {
            ...
            var $this = $(this);
            if (visible[0]) { $(options.getActiveElement(visible[0].attr("id"))).removeClass(options.activeClass); if ($this.data("scrollSpy:id") < visible[0].data("scrollSpy:id")) { visible.unshift($(this)) } else { visible.push($(this)) } } else { visible.push($(this)) }
        ...
        selector.on("scrollSpy:exit", function() {
            ...
            if (visible[0]) {
                ...
                if (visible[0]) { $(options.getActiveElement(visible[0].attr("id"))).addClass(options.activeClass) }
            }
        });
        return selector
    };
    ...
    $(document).ready(function() {
        ...
        $.fn.autocomplete = function(options) {
            ...
            return this.each(function() {
                ...
                } else { $input.off("keyup.autocomplete focus.autocomplete") }
            })
        }
    });
    ...
    var methods = {
        init: function(options) {
            ...
            return this.each(function() {
                ...
                $this.hammer({ prevent_default: false }).on("pan", function(e) {
                    if (e.gesture.pointerType === "touch") {
                        clearInterval($interval);
                        var direction = e.gesture.direction;
                        ...
                        if (direction === 4 && (x > $this.innerWidth() / 2 || velocityX < -.65)) { swipeRight = true } else if (direction === 2 && (x < -1 * $this.innerWidth() / 2 || velocityX > .65)) { swipeLeft = true }
                        var next_slide;
                        if (swipeLeft) {
    ...
    $.fn.material_chip = function(options) {
        ...
        this.handleEvents = function() {
            ...
            self.$document.off("focusout.chips", SELS.CHIPS + " " + SELS.INPUT).on("focusout.chips", SELS.CHIPS + " " + SELS.INPUT, function(e) {
                ...
                if ($currChips.data("chips") === undefined || !$currChips.data("chips").length) { $currChips.siblings("label").removeClass("active") }
        ...
        this.chips = function($chips, chipId) {
            ...
            if (label.length) { label.attr("for", chipId); if ($chips.data("chips") !== undefined && $chips.data("chips").length) { label.addClass("active") } }
            var input = $("#" + chipId);
        ...
        this.renderChip = function(elem) {
            ...
            if (elem.image) { $renderedChip.prepend($("<img />").attr("src", elem.image)) }
        ...
        $(".dismissable").each(function() {
            $(this).hammer({ prevent_default: false }).on("pan", function(e) {
                if (e.gesture.pointerType === "touch") {
                    ...
                    if (direction === 4 && (x > $this.innerWidth() / 2 || velocityX < -.75)) { swipeLeft = true }
                    if (direction === 2 && (x < -1 * $this.innerWidth() / 2 || velocityX > .75)) { swipeRight = true }
                }
            }).on("panend", function(e) {
...
(function(factory) { Materialize.Picker = factory(jQuery) })(function($) {
    ...
    function PickerConstructor(ELEMENT, NAME, COMPONENT, OPTIONS) {
            ...
            P = PickerInstance.prototype = {
                ...
                open: function(dontGiveFocus) {
                    ...
                    if (dontGiveFocus !== false) {
                        ...
                        P.$root.eq(0).focus();
                        $document.on("click." + STATE.id + " focusin." + STATE.id, function(event) { var target = event.target; if (target != ELEMENT && target != document && event.which != 3) { P.close(target === P.$root.children()[0]) } }).on("keydown." + STATE.id, function(event) {
                            var keycode = event.keyCode,
                                keycodeToMove = P.component.key[keycode],
                                target = event.target;
                            if (keycode == 27) { P.close(true) } else if (target == P.$root[0] && (keycodeToMove || keycode == 13)) { event.preventDefault(); if (keycodeToMove) { PickerConstructor._.trigger(P.component.key.go, P, [PickerConstructor._.trigger(keycodeToMove)]) } else if (!P.$root.find("." + CLASSES.highlighted).hasClass(CLASSES.disabled)) { P.set("select", P.component.item.highlight); if (SETTINGS.closeOnSelect) { P.close(true) } } } else if ($.contains(P.$root[0], target) && keycode == 13) {
                ...
                get: function(thing, format) {
                    ...
                    if (thing in P.component.item) { if (typeof format == "string") { var thingValue = P.component.get(thing); return thingValue ? PickerConstructor._.trigger(P.component.formats.toString, P.component, [format, thingValue]) : "" } return P.component.get(thing) }
                },
                ...
                trigger: function(name, data) {
                    var _trigger = function(name) { var methodList = STATE.methods[name]; if (methodList) { methodList.map(function(method) { PickerConstructor._.trigger(method, P, [data]) }) } };
                    _trigger("_" + name);
                    _trigger(name);
                    return P
                }
        ...
        function handleKeydownEvent(event) {
            ...
            if (keycode == 27) { P.close(); return false }
    ...
    PickerConstructor.extend = function(name, Component) {
        $.fn[name] = function(options, action) { var componentData = this.data(name); if (options == "picker") { return componentData } if (componentData && typeof options == "string") { return PickerConstructor._.trigger(componentData[options], componentData, [action]) } return this.each(function() { var $this = $(this); if (!$this.data(name)) { new PickerConstructor(this, name, Component, options) } }) };
...
(function(factory) { factory(Materialize.Picker, jQuery) })(function(Picker, $) {
    var DAYS_IN_WEEK = 7,
        WEEKS_IN_CALENDAR = 6,
        _ = Picker._;
    ...
    DatePicker.prototype.set = function(type, value, options) {
        ...
        calendarItem[type == "enable" ? "disable" : type == "flip" ? "enable" : type] = calendar.queue[type].split(" ").map(function(method) { value = calendar[method](type, value, options); return value }).pop();
    ...
    DatePicker.prototype.isDateOverlap = function(one, two) {
        ...
        if (_.isInteger(one) && (_.isDate(two) || $.isArray(two))) { one = one % 7 + firstDay; return one === calendar.create(two).day + 1 }
    ...
    DatePicker.prototype.deactivate = function(type, datesToDisable) {
        ...
        if (datesToDisable == "flip") { calendar.flipEnable() } else if (datesToDisable === false) {
            ...
            calendar.flipEnable(-1);
            disabledItems = []
        } else { datesToDisable.map(function(unitToDisable) { var matchFound; for (var index = 0; index < disabledItems.length; index += 1) { if (calendar.isDateExact(unitToDisable, disabledItems[index])) { matchFound = true; break } } if (!matchFound) { if (_.isInteger(unitToDisable) || _.isDate(unitToDisable) || $.isArray(unitToDisable) || $.isPlainObject(unitToDisable) && unitToDisable.from && unitToDisable.to) { disabledItems.push(unitToDisable) } } }) }
            ...
            datesToEnable.map(function(unitToEnable) {
                ...
                for (index = 0; index < disabledItemsCount; index += 1) {
                    ...
                    if (calendar.isDateExact(disabledUnit, unitToEnable)) {
                        ...
                        } else if ($.isArray(unitToEnable)) { matchFound = unitToEnable; if (!matchFound[3]) matchFound.push("inverted") } else if (_.isDate(unitToEnable)) { matchFound = [unitToEnable.getFullYear(), unitToEnable.getMonth(), unitToEnable.getDate(), "inverted"] }
                        break
                    }
                }
                if (matchFound)
            ...
            item: function(rowCounter) {
                ...
                return [_.group({
                    ...
                    item: function(targetDate) {
                        ...
                        return [_.node("div", targetDate.date, function(klasses) { klasses.push(viewsetObject.month == targetDate.month ? settings.klass.infocus : settings.klass.outfocus); if (nowObject.pick == targetDate.pick) { klasses.push(settings.klass.now) } if (isSelected) { klasses.push(settings.klass.selected) } if (isHighlighted) { klasses.push(settings.klass.highlighted) } if (isDisabled) { klasses.push(settings.klass.disabled) } return klasses.join(" ") }([settings.klass.day]), "data-pick=" + targetDate.pick + " " + _.ariaAttr({ role: "gridcell", label: formattedDate, selected: isSelected && calendar.$node.val() === formattedDate ? true : null, activedescendant: isHighlighted ? true : null, disabled: isDisabled ? true : null }) + " " + (isDisabled ? "" : 'tabindex="0"')), "", _.ariaAttr({ role: "presentation" })]
                    }
                })]
            }
...
(function() {
    ...
    function ClockPicker(element, options) {
        ...
        function mousedown(e, space) {
            ...
            e.preventDefault();
            var movingTimer = setTimeout(function() { self.popover.addClass("clockpicker-moving") }, 200);
    ...
    ClockPicker.prototype.show = function(e) {
        ...
        $(":input").each(function() { $(this).attr("tabindex", -1) });
        var self = this;
        this.input.blur();
        ...
        if (this.options.twelvehour && !(typeof value[1] === "undefined")) {
            if (value[1].indexOf("AM") > 0) { this.amOrPm = "AM" } else { this.amOrPm = "PM" }
    ...
    ClockPicker.prototype.toggleView = function(view, delay) {
        ...
        this.toggleViewTimer = setTimeout(function() { hideView.css("visibility", "hidden") }, duration);
    ...
    ClockPicker.prototype.setHand = function(x, y, roundBy5, dragging) {
        ...
        radian = value * unit;
        if (options.twelvehour) { if (isHours) { if (value === 0) value = 12 } else { if (roundBy5) value *= 5; if (value === 60) value = 0 } } else {
            if (isHours) {
                if (value === 12) value = 0;
                value = inner ? value === 0 ? 12 : value : value === 0 ? 0 : value + 12
            } else { if (roundBy5) value *= 5; if (value === 60) value = 0 }
        }
        ...
        if (isHours) { this["spanHours"].html(value) } else { this["spanMinutes"].html(leadingZero(value)) }
        if (!svgSupported) {
    ...
    ClockPicker.prototype.done = function() {
        ...
        if (value !== last) { this.input.triggerHandler("change"); if (!this.isInput) { this.element.trigger("change") } }
    ...
    $.fn.pickatime = function(option) {
        ...
        return this.each(function() {
            ...
            } else { if (typeof data[option] === "function") { data[option].apply(data, args) } }
        })
    }
})();
(function($) {
...
(function($) {
    var methods = {
            ...
            return this.each(function(i) {
                ...
                var setCarouselHeight = function(imageOnly) {
                    ...
                    if (firstImage.length) {
                        if (firstImage[0].complete) {
                            ...
                            if (imageHeight > 0) { view.css("height", firstImage.height()) } else {
                                var naturalWidth = firstImage[0].naturalWidth;
                                var naturalHeight = firstImage[0].naturalHeight;
                                var adjustedHeight = view.width() / naturalWidth * naturalHeight;
                                view.css("height", adjustedHeight)
                            }
                        } else { firstImage.on("load", function() { view.css("height", $(this).height()) }) }
                    } else if (!imageOnly) {
                ...
                function scroll(x) {
                    ...
                    if (!noWrap || center >= 0 && center < count) {
                        ...
                        el.style.zIndex = 0;
                        if (options.fullWidth) { tweenedOpacity = 1 } else { tweenedOpacity = 1 - .2 * tween }
                ...
                function release(e) {
                    ...
                    if (noWrap) { if (target >= dim * (count - 1)) { target = dim * (count - 1) } else if (target < 0) { target = 0 } }
        ...
        next: function(n, callback) { $(this).trigger("carouselNext", [n, callback]) },
        prev: function(n, callback) { $(this).trigger("carouselPrev", [n, callback]) },
        set: function(n, callback) { $(this).trigger("carouselSet", [n, callback]) },
        destroy: function() {
            ...
            if (typeof window.ontouchstart !== "undefined") { $(this).off("touchstart.carousel touchmove.carousel touchend.carousel") }
